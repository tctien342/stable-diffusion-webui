...
class BGRemovedModelType(str, Enum):
    """Enum for Background Removal Models"""

    U2NET = "u2net"
    U2NETP = "u2netp"
    U2NET_HUMAN = "u2net_human_seg"
    U2NET_CLOTHE = "u2net_cloth_seg"
...
class RemoveBackgroundResponse(BaseModel):
    image: str = Field(
        title="Return image which removed background",
        description="The image which removed background in base64 format.",
    )
    model: BGRemovedModelType = Field(
        title="Model", description="The model used to remove background."
    )


class RemoveBackgroundResquest(BaseModel):
    image: str = Field(
        title="Input image",
        description="The image which need to be removed background in base64 format.",
    )
    model: BGRemovedModelType = Field(
        title="Model", description="The model used to remove background."
    )
